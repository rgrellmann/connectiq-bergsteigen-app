...
class Background1 extends WatchUi.Drawable {
    ...
    function initialize() {
        println("Background1.initialize");
        Drawable.initialize({:identifier => "Background1"});
        println("end Background1.initialize");
    }
    ...
    function setColor(color) {
        println("Background1.setColor");
        backgroundColor = color;
        println("end Background1.setColor");
    }
