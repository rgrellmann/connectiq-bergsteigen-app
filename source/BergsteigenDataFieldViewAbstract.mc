...
//        timer = new Timer.Timer();
        println("end BergsteigenDataFieldViewAbstract.initialize");
    }

//    // DataField background color
    public function getBackgroundColor() {
        println("BergsteigenDataFieldViewAbstract.getBackgroundColor");
        var backgroundColor = Application.getApp().Properties.getValue("backgroundColor");
        println("end BergsteigenDataFieldViewAbstract.getBackgroundColor: " + backgroundColor);
